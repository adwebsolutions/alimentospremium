...
function optionsframework_add_admin() {
    ...
    $of_page = add_theme_page( 'wp_organicfood', 'Theme Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
...
function of_ajax_callback()
{
    ...
    elseif ($save_type == 'reset')
    {
        ...
        $option_json = get_template_directory_uri() . '/admin/option.txt';
