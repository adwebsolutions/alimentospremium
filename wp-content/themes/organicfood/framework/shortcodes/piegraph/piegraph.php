...
function ww_shortcode_piegraph_render($atts, $content = null) {
    ...
    ob_start();
    ?>
        <div class="pie-graph <?php echo $el_class;?>" data-id="percent_loader<?php echo $date; ?>" data-percent="<?php echo $percent;?>" data-radius="<?php echo $radius;?>" data-color="<?php echo $color;?>">
