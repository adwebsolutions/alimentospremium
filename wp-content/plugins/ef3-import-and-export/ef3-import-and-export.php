    ...
    final class EF3_Import_Export
    {
        ...
        function ajax_inport(){
            ...
            switch ($_REQUEST['import']) {
                ...
                /* import widgets. */
                case 'widgets':
                    $response = ef3_widgets_process_import_file($folder_dir . 'widgets.wie');;
                    break;
                ...
                case 'clear':
                    ...
                    break;
                case 'finish':
                    do_action('ef3-import-finish', $_REQUEST['id']);
        ...
        function ajax_export(){
            ...
            switch ($export_action) {
                ...
                /* export widgets. */
                case 'widgets':
                    $response = ef3_widgets_save_export_file($folder_dir . 'widgets.wie');
                    break;
